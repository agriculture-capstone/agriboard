...
import {
  ...
  DrawerState,
  ToggleDrawerPayload,
} from '@/store/modules/drawer/types';
import mutationHandlers from '@/store/modules/drawer/mutations';
import { buildCallMutationHandler } from '@test/unit/test-utils/buildCallHandlers';

describe('App Store mutations', function () {

  const callMutationHandler = buildCallMutationHandler<DrawerState, MutationType>(mutationHandlers);
